...
void firstPass() {
    ...
    for (int i = 0; i < indices; i++) {
        ...
        int steps = (strchr(input[i], splitBy)[1] - 48);
    ...
    printf("Final position: %d, depth: %d\nCalculated value: %d\n", position, depth, (position * depth));
}
